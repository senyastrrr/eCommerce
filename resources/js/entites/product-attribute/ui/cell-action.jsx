...
import { useDeleteProductAttribute } from "..";
...
export const CellAction = ({
  ...
  const onConfirm = async () => {
    try {
      setLoading(true);
      deleteProductAttribute.mutate(data.id);
  ...
  const onCopy = (id) => {
    ...
    toast.success('Product Attribute ID copied to clipboard.');
  }
    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem
            onClick={() => window.location.href = `/admin/product-attributes/edit/${data.id}`}
          >
