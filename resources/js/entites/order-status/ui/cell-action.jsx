...
import { useDeleteOrderStatus } from "..";
...
export const CellAction = ({
  ...
  const onConfirm = async () => {
    try {
      setLoading(true);
      deleteOrderStatus.mutate(data.id);
  ...
  const onCopy = (id) => {
    ...
    toast.success('Order Status ID copied to clipboard.');
  }
    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem
            onClick={() => window.location.href = `/admin/order-statuses/edit/${data.id}`}
          >
