...
import { useDeleteProductConfiguration } from "..";
...
export const CellAction = ({
  ...
  const onConfirm = async () => {
    try {
      setLoading(true);
      deleteProductConfiguration.mutate(data.id);
  ...
  const onCopy = (id) => {
    ...
    toast.success('Product Configuration ID copied to clipboard.');
  }
    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem
            onClick={() => window.location.href = `/admin/product-configurations/edit/${data.id}`}
          >
