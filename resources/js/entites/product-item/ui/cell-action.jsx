...
import { useDeleteProductItem } from "..";
...
export const CellAction = ({
  ...
  const onConfirm = async () => {
    try {
      setLoading(true);
      deleteProductItem.mutate(data.id);
  ...
  const onCopy = (id) => {
    ...
    toast.success('Product Item ID copied to clipboard.');
  }
    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem
            onClick={() => window.location.href = `/admin/product-items/edit/${data.id}`}
          >
